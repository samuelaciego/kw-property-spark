...
import { Search, Filter, Download, Eye, Calendar, BarChart3, Home, Image, Video, TrendingUp, Loader2 } from "lucide-react";
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {filteredProperties.slice(0, 10).map(property => (
                  <div key={property.id} className="flex items-center justify-between p-4 border border-border/50 rounded-lg hover:bg-muted/20 transition-colors">
