...
export function HeroSection() {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto animate-slide-up" style={{
          animationDelay: "0.2s"
        }}>
            {t.heroSubtitle}
          </p>
          ...
          {/* Features List */}
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-3 sm:gap-6 mb-10 animate-slide-up" style={{
          animationDelay: "0.4s"
        }}>
            ...
            <div className="flex items-center text-sm sm:text-base text-muted-foreground">
              <Sparkles className="h-5 w-5 text-accent mr-2 flex-shrink-0" />
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-slide-up" style={{
          animationDelay: "0.6s"
        }}>
            <Button size="lg" className="bg-gradient-hero hover:shadow-glow transition-all duration-300 text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 w-full sm:w-auto" asChild>
